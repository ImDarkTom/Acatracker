...
<template>
    <div v-if="!authStore.isLoading.value && authStore.user" class="group relative overflow-visible">
    ...
    <button v-else :disabled="authStore.isLoading.value" @click="authStore.signIn" class="disabled:opacity-50 not-disabled:cursor-pointer">
        <Icon v-if="authStore.isLoading.value" name="mdi:loading" class="animate-spin" />
